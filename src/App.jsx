...
const PLAYERS = [
  { id: 1, num: "01", name: "Kai", title: "The Director", role: "Cameraman & Game Master", bio: "Directs the games, directs the camera, runs the whole production. Something switches when he's on holiday — he transforms into a completely different person. Expect maximum energy, maximum content, and zero chill.", color: C.blue, emoji: "🎬", avatar: "/images/avatars/kai.png" },
...
const DAYS = [
  ...
  { date: "26 May", dow: "Tue", title: "Wind-down", tagline: "Vibe it out", who: ["Kai", "Khari", "Camara"], status: "resort", items: [{ time: "Day", activity: "Pool / beach / chill", icon: "🏖️" }, { time: "18:35", activity: "Camara departs (AV137)", icon: "✈️" }, { time: "Eve", activity: "Lads chill / no fixed plans", icon: "🌙" }] },
  { date: "27 May", dow: "Wed", title: "Wind-down", tagline: "Vibe it out", who: ["Kai", "Khari"], status: "resort", items: [{ time: "Day", activity: "No fixed plans", icon: "🌴" }, { time: "Eve", activity: "Resort dinner", icon: "🍽️" }] },
  { date: "28 May", dow: "Thu", title: "Wind-down", tagline: "Vibe it out", who: ["Kai", "Khari"], status: "resort", items: [{ time: "Day", activity: "No fixed plans", icon: "🌴" }, { time: "Eve", activity: "Resort dinner", icon: "🍽️" }] },
  { date: "29 May", dow: "Fri", title: "Departure", tagline: "Until next time, paradise", who: ["Kai", "Khari"], status: "resort", items: [{ time: "AM", activity: "Pack / chill", icon: "🧳" }, { time: "13:30", activity: "Leave for airport", icon: "🚐" }, { time: "17:10", activity: "Flight home (TOM569)", icon: "✈️" }] },
];
      ...
      <section id="itinerary" style={{ padding: "80px 0 60px", background: C.white }}>
        <Reveal>
          <div style={{ textAlign: "center", marginBottom: 32, padding: "0 24px" }}>
            ...
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: 14, color: C.textBody, marginTop: 8, fontWeight: 600 }}>Swipe through — tap a day to expand · tap any link to see what we're suggesting</p>

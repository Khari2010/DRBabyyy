...
const PLAYERS = [
  { id: 1, num: "01", name: "Kai", title: "The Director", role: "Cameraman & Game Master", bio: "Something switches when he's on holiday — he transforms into a completely different person.", about: "Self-appointed Game Master and one of the masterminds behind the trip alongside Kyanna and Candice. A huge driver of the activities, challenges, and all the chaos that comes with them. His main job? Cameraman — he'll be filming absolutely everything because the group is making a big vlog at the end. Loves games, competitions, and anything with stakes. Expect maximum energy, maximum content, and zero chill.", color: C.blue, emoji: "🎬", avatar: "/images/avatars/kai.png" },
  { id: 2, num: "02", name: "Khari", title: "The Gaffer", role: "The overseer — keeps everything running", bio: "Doesn't stress about challenges or competitions, but somehow never really loses either.", about: "Kai's older brother and the fatherly figure of the group — steady, reliable, always got advice whether you asked for it or not. The quiet confidence that holds the whole trip together.", color: C.gold, emoji: "🧔‍♂️", avatar: "/images/avatars/khari.png" },
  { id: 3, num: "03", name: "Candice", title: "The Sunshine", role: "TikTok queen & the smile that lights up the room", bio: "First one up, last one to care. Brings the vibes that make the trip legendary.", about: "The group's reckless lover girl. Super funny, super chaotic — the kind of energy that turns a quiet evening into a story nobody's allowed to repeat. One thing's for certain though: she will NOT be sharing a bed with Kyanna. Don't ask, just know. Expect chaos, laughter, and absolutely zero regrets.", color: C.coral, emoji: "☀️", avatar: "/images/avatars/candice.png" },
  { id: 4, num: "04", name: "Kyanna", title: "The Ex-Wildcard", role: "Claims she's retired from the chaos. We'll see.", bio: "Quiet until she's not. Expect the unexpected — that's the whole point.", about: "The best flirt in the group — knows exactly what to say and exactly when to say it. Smart, pretty, and down for anything... as long as \"dese man\" do it first. A core part of the planning team alongside Kai and Candice, and Kai's best friend. Don't underestimate the quiet ones.", color: C.purple, emoji: "😈", avatar: "/images/avatars/kyanna.png" },
  { id: 5, num: "05", name: "Camara", title: "The Messy One", role: "Never stops, never sleeps, always tries to be the main character", bio: "Knows everyone within 30 minutes of landing. Somehow always finds the best spots.", about: "The most chaotic member of the group by a mile. Does way too much, all of the time. Deeps the most ridiculous things and you will absolutely find him in the most compromising scenarios — guaranteed. Cannot handle his drink at all but is fully convinced he's the best drunk in the group. He's not. Buckle up.", color: C.green, emoji: "💣", avatar: "/images/avatars/camara.png" },
  { id: 6, num: "06", name: "Miles", title: "The Joker", role: "Funniest in the room, first to disappear", bio: "Moves in silence but hits different. By day 3, the resort will know his name.", about: "The most non-committal committal guy in the group. Everything's a possibility, nothing's a reality. We'll believe he's actually coming when we see him step off the plane in DR — not a second before. Honestly, the group is just happy he said yes. If he shows up, that alone is the plot twist of the trip.", color: C.cyan, emoji: "🃏", avatar: "/images/avatars/miles.png" },
];

...
const PLAYERS = [
  { id: 1, num: "01", name: "Kai", title: "The Director", role: "Cameraman & Game Master", bio: "Something switches when he's on holiday — expect maximum energy and zero chill.", about: "One of the masterminds behind the trip alongside Kyanna and Candice. A huge driver of the activities, challenges, and all the chaos that comes with them. He'll be filming absolutely everything because the group is making a big vlog at the end. Loves games, competitions, and anything with stakes. He transforms into a completely different person on holiday.", color: C.blue, emoji: "🎬", avatar: "/images/avatars/kai.png" },
  { id: 2, num: "02", name: "Khari", title: "The Gaffer", role: "The overseer — keeps everything running", bio: "Doesn't stress about challenges or competitions, but somehow never really loses either.", about: "Adan's older brother and the fatherly figure of the group. Steady, reliable, always got advice whether you asked for it or not. The quiet confidence that holds the whole trip together.", color: C.gold, emoji: "🧔‍♂️", avatar: "/images/avatars/khari.png" },
